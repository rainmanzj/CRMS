# Generated by Django 2.1.1 on 2019-04-27 09:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, limit_choices_to={'depart__title': '销售部'}, null=True, on_delete='cascade', related_name='consultant', to='generic.Staffinfo', verbose_name='课程顾问')),
                ('course', models.ManyToManyField(to='generic.Course', verbose_name='咨询课程')),
                ('referral_from', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', null=True, on_delete='cascade', related_name='internal_referral', to='generic.Customer', verbose_name='转介绍自学员')),
            ],
        ),
